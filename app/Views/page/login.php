    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="<?= base_url('/') ?>"><img src="<?= base_url('./assets/compiled/png/logo3.png') ?>" alt="Logo" style="height: 100px"></a>
                    </div>
                    ...
                    <form class="form" method="POST" action="#" data-parsley-validate>
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" name="password" class="form-control form-control-xl" placeholder="Password" data-parsley-required="true" />
                            <div class="form-control-icon">
        ...
        $('form').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = "<?= base_url('p/dash') ?>";
                },
